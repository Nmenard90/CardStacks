...
import {
  basePrice, cardValue, fromCondList, toCondList, totalQty, type CondMap,
} from '../lib/conditions'
    ...
    <div className="page-tracker">
      <div id="app" style={{ display: 'block' }}>
        ...
        <div className="toolbar">
          ...
          <button className="tb-btn" onClick={() => setExportOpen(true)}>⬇ Export CSV</button>
      ...
      <ExportModal
        ...
        selectedSetId={activeSetId && activeSetId !== ALL_SETS ? activeSetId : null}
        selectedSetName={
          activeSetId && activeSetId !== ALL_SETS
            ? sets.find(s => s.id === activeSetId)?.name
            : undefined
        }
      />
